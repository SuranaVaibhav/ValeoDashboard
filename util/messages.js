jQuery.sap.declare("ValeoDashboard.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

ValeoDashboard.util.messages = {};
 ...
 * @public
 */
ValeoDashboard.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = ValeoDashboard.util.messages._parseError(oParameter);
...
ValeoDashboard.util.messages.moment= function(evt){
...
ValeoDashboard.util.messages.getErrorContent = function(oParameter) {
	return ValeoDashboard.util.messages._parseError(oParameter).sMessage;
};

ValeoDashboard.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
