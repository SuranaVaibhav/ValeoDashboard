...
jQuery.sap.declare("ValeoDashboard.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.History");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");
// jQuery.sap.require("ValeoDashboard.MyRouter");

sap.ui.core.UIComponent.extend("ValeoDashboard.Component", {
	metadata: {
		"name": "ValeoDashboard",
		"version": "1.1.0-SNAPSHOT",
		"library": "ValeoDashboard",
		"includes": ["css/fullScreenStyles.css","js/d3.min.js","js/D3-donutChart.js"],
		"dependencies": {
	...
	// 		routing: {
	// 		config: {
	// 			routerClass: "ValeoDashboard.MyRouter",
	// 			viewType: "XML",
	// 			viewPath: "ValeoDashboard.view",
	...
	createContent: function() {
		...
		return sap.ui.view({
			viewName: "ValeoDashboard.view.Main",
	...
	init: function() {
		...
		var sRootPath = jQuery.sap.getModulePath("ValeoDashboard");
